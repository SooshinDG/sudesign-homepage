...
export default async function PortfolioDetailPage({ params }: Props) {
  ...
  return (
    <>
      {/* ── Hero — dark ── */}
      <section className="bg-dark pt-44 pb-0">
        ...
        <div className="container-main">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 xl:gap-20">
            ...
            <div className="lg:col-span-7">
              ...
              {/* Challenge callout */}
              <blockquote
                className="text-base md:text-lg text-dark/85 leading-relaxed font-light
              ...
              {/* Story paragraphs */}
              <div className="space-y-5 text-dark/65 text-sm leading-loose">
